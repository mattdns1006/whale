...
\begin{figure}[H]
\subfigure[]{\includegraphics[width=\twoPic\textwidth]{images/histMatch/images.png}}
\subfigure[]{\includegraphics[width=\twoPic\textwidth]{images/histMatch/density.jpg}}
\label{fig:histMatch}
\end{figure}
...
\foreach \x in {1,2} 
{
\subfigure[]{\includegraphics[width=\twoPic\textwidth]{images/histMatch/results\x .png}}
}
